              ...
              >
                ...
                <div>
                  <button
                    ...
                    className="w-full border border-gray-300 rounded-d outline-none p-5 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                  >
                ...
                <div className="mt-4">
                  ...
                  py-2 text-sm font-medium text-blue-900 hover:bg-blue-200
